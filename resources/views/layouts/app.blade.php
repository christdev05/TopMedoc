                    ...
                    <div class="header-nav d-none d-lg-flex">
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                  @livewire('list-category-component')
                                        ...
                                        <li><a href="#">Mon Compte<i class="fi-rs-angle-down"></i></a>
                                                @if (Auth::user()->utype == 'ADM')
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="{{route('admin.homeslider')}}">Home</a></li> 
                                                                    
                                                    </ul>
                                                    @elseif (Auth::user()->utype == 'Livreur')
                                                        <ul class="sub-menu">
                                                            <li><a href="{{route('livreur.dashboard')}}">Tableau de bord</a></li> 
                                                            <li><a href="#">Commande</a></li>                                           
                                                        </ul>

                                                    @elseif (Auth::user()->utype == 'Pharmacie')

                                                    <ul class="sub-menu">
                                                        <li><a href="{{route('pharmacie.dashboard')}}">Tableau de bord</a></li> 
                                                        <li><a href="#">Commande</a></li>                                           
                                                    </ul>
                                                    @else
                                                    <ul class="sub-menu">
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="{{route('home.index')}}">ACCEUIL</a></li>
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="{{route('shop')}}">PRODUIT</a></li>
