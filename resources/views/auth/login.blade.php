                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="email"  name="email" required="" placeholder="Addresse Mail" :value="old('email')" required autofocus>
                                            </div>
                                            <div class="form-group">
                                                <input  type="password" name="password"  required="" placeholder="Mot de passe" required autocomplete="current-password">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-fill-out btn-block hover-up" name="login">CONNECTEZ-VOUS</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
